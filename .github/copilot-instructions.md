...
This file mirrors the repository's source-of-truth conventions (AGENTS.md).
...
## Shell script conventions (omvBorgBackup.sh, omvBorgMaintenance.sh, syncFolders.sh)
